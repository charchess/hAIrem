...
class TestUserMemoryService:
    ...
    async def test_get_user_memories_success(self):
        ...
        mock_surreal.semantic_search_user.return_value = [{"content": "User likes coffee", "user_id": "user_123"}]
    ...
    async def test_get_universal_memories(self):
        ...
        mock_surreal = AsyncMock()
        mock_surreal.semantic_search_universal.return_value = [{"content": "System fact", "user_id": None}]
...
class TestMemoryConsolidatorUserId:
    ...
    async def test_consolidate_associates_user_id(self):
        ...
        mock_llm.get_completion.return_value = '{"facts": [{"fact": "User likes green tea", "subject": "user", "confidence": 0.9}], "causal_links": [], "concepts": []}'
    ...
    async def test_consolidate_uses_primary_user_id(self):
        ...
        mock_llm.get_completion.return_value = (
            '{"facts": [{"fact": "Fact 1", "subject": "user", "confidence": 0.9}], "causal_links": [], "concepts": []}'
        )
        mock_llm.get_embedding.return_value = [0.1, 0.2]
        mock_surreal.semantic_search.return_value = []

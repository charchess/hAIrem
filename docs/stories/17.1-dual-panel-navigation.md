# Story 17.1: Dual Panel Navigation & Modal UX
...
1. **Navigation Refactor:**
    ...
    - **Button 1 (Control Panel):** Icon ⚙️. Opens technical settings.
    - **Button 2 (Crew):** Icon 👥. Opens the agent management panel.
2. **Naming Convention:**
...
- Refactored `index.html` to replace text buttons with icons (⚙️, 👥) and renamed IDs.
...
- Coding Standards: [✓]
- Project Structure: [✓]
- Testing Strategy: [✓] (Playwright Live Audit)
- All ACs Met: [✓]

### Gate Status
Gate: PASS → docs/qa/gates/17.1-ui-nav-fixed.yml
Risk profile: Low
NFR assessment: PASS
